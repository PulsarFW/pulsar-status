...
# PULSAR-STATUS
**Player needs and status effect management for Pulsar Framework**
...
Tracks and manages player status effects including hunger, thirst, stress, and other configurable needs. Server-authoritative with client-side polling and HUD integration.
